...
parser = argparse.ArgumentParser(description='GDZero: PyTorch Guandan AI')
...
parser.add_argument('--wip', default='192.168.1.100', type=str, help='worker ip')
parser.add_argument('--wport', default='13000', type=str, help='worker port')
...
parser.add_argument('--train_actor_num', default=13, type=int,
                    help='extra train actor num')
parser.add_argument('--extra_cpu_actor', action='store_true',
                    help='Use CPU as extra actor device')
parser.add_argument('--extra_cpu_actor_num', default=27,type=int,
...
parser.add_argument('--num_actors', default=0, type=int,
...
parser.add_argument('--game_nums', default=30, type=int,
                    help='Root dir where experiment data will be saved')
